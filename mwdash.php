    ...
    <div class="main-content">
        ...
        <div id="services-section" class="content-section" style="margin-top: 25px; display: none; background: rgba(255, 255, 255, 0.95);">
            ...
            <div id="services-blank-state" style="text-align: center; padding: 80px 20px; color: #6b7280;">
                ...
                <button type="button" onclick="document.getElementById('addServiceModal').style.display='flex';" 
                    style="margin-top: 10px; padding: 10px 20px; background: red; color: white; border: none; border-radius: 5px; cursor: pointer;">
                    TEST MODAL
                </button>
            </div>
    ...
    <script>
            ...
            if (openAddServiceModalFromBlank) {
                ...
                openAddServiceModalFromBlank.addEventListener('click', function(e) {
                    e.preventDefault();
                    e.stopPropagation();
                    console.log('Add Service button from blank state clicked');
                    console.log('Modal element:', addServiceModal);
                    console.log('Modal current display:', addServiceModal.style.display);
                    if (addServiceModal) {
                        addServiceModal.style.display = 'flex';
